...
private double resultado;
  ...
  public double descontoSeguro(int classeBonus){
    ...
    switch (classeBonus){
      case 1: retorno = 0.05; // 5%
      break ;
      
      case 2 : retorno = 0.06; // 6%
      break ;
      
      case 3: retorno = 0.065; // 6,5%
      break ;
      
      case 4: retorno = 0.07; // 7%
      break ;
      
      case 5: retorno = 0.08;
      break ;
      
      case 6: retorno =0.085;
      break ;
      
      case 7: retorno = 0.087; // 8,7%
      break;
      
      case 8 : retorno = 0.090; // 9%
      break ;
      
      case 9: retorno = 0.096; //9,6%
      break ;
      
      case 10: retorno = 0.10; // 10%
      break ;
    }
    return retorno;
  }
